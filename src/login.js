            ...
            <div className='col-md-6 d-flex justify-content-center'>
                <form onSubmit={handlesubmit}>
                    ...
                    <div className='input-group mb-3 justify-content-center'>
                        <button className='register-btn btn border-white text-white w-50 fs-6' type="submit">Register</button>
                    </div>
                </form>
            </div>
            {/* {/------------Login form--------------/} */}
            ...
            <div className='register-switch-content'>
                <div className='register-switch'>
                    <div className='register-switch-panel register-switch-left'>
                        ...
                        <button  className='hidden btn register-btn text-whiyte w-50 fs-6' id='login' style={{padding:'10px 10px',border:'1px solid white'}} onClick={SwitchContent}>Login</button>
                    </div>
                    <div className='register-switch-panel register-switch-right'>
                        <h1>Welcome</h1>
                        <p>Join Our Unique Platform, Explore a New Experience</p>
                        <button className='hidden btn register-btn border-white text-whiyte w-50 fs-6' id='register' onClick={SwitchContent}>Register</button>
                    </div>
                </div>
            </div>
        </div>
