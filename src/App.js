...
//                   <h1 className='h1'><span>  About </span> Us</h1>    
      
//         <h2>We Take Care Of Your<br></br> Healthy Life</h2>
//         <p>Lorem Ipsum Dolor Sit Amet Consectetur, Adipisicing Elit. Iure<br></br> Ducimus, Quod Ex Cupiditate Ullam In Assumenda Maiores Et Culpa<br></br> Odit Tempora Ipsam Qui, Quisquam Quis Facere Iste Fuga, Minus<br></br> Nesciunt.</p>
//         <p>Lorem Ipsum Dolor, Sit Amet Consectetur Adipisicing Elit. Natus Vero<br></br> Ipsam Laborum Porro Voluptates Voluptatibus A Nihil Temporibus<br></br> Deserunt Vel?</p>
...
// </svg></button>
//                            <button> <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-linkedin" viewBox="0 0 16 16">
...
//           </div>
//     </div>
//     <div><center><h1>OUR<span> BLOGS</span></h1></center>
//     <div className="client">
//       <div className="card1">
//         <img src={i}></img>
